...
class ReweReceiptParserTest {
    ...
    fun quantityLineUpdatesAmountAndPrice() {
        ...
        assertEquals("05.03.2024", result.date)
    ...
    fun parsesReceiptDateFromGermanFormat() {
        assertEquals(LocalDate(2024, 1, 1), parseReceiptDate("01.01.2024"))
    }

    @Test
    fun parsesReceiptDateFromIsoTimestamp() {
        assertEquals(LocalDate(2026, 2, 2), parseReceiptDate("2026-02-02T14:29:13.000"))
    }
